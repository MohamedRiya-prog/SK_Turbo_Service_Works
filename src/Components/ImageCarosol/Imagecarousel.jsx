...
import { TurboCharger, Image1, Image2, Image3, Image4, Image5, Image6, Image7, Image8} from "../Assets";
    ...
    <div ref={containerRef} className="carousel-container">
      <Slider {...settings}>
        <div className={`transform scale-90 transition-all duration-300 ${currentSlide === 0 ? 'opacity-100' : 'opacity-10'} hover:opacity-100 hover:scale-100 flex flex-col items-center`}>
          ...
          <p className="text-center text-sm font-poppins mt-2">Turbo charger</p>
        </div>
        <div className={`transform scale-90 transition-all duration-300 ${currentSlide === 1 ? 'opacity-100' : 'opacity-10'} hover:opacity-100 hover:scale-100`}>
          ...
          <p className="text-center text-sm font-poppins mt-2">Actuator</p>
        </div>
        <div className={`transform scale-90 transition-all duration-300 ${currentSlide === 2 ? 'opacity-100' : 'opacity-10'} hover:opacity-100 hover:scale-100`}>
          ...
          <p className="text-center text-sm font-poppins mt-2">Compressor Wheel</p>
        </div>
        <div className={`transform scale-90 transition-all duration-300 ${currentSlide === 3 ? 'opacity-100' : 'opacity-10'} hover:opacity-100 hover:scale-100`}>
          ...
          <p className="text-center text-sm font-poppins mt-2">CHRA</p>
        </div>
        ...
        <div className={`transform scale-90 transition-all duration-300 ${currentSlide === 5 ? 'opacity-100' : 'opacity-10'} hover:opacity-100 hover:scale-100`}>
          ...
          <p className="text-center text-sm font-poppins mt-2">Turbo charger Assembly</p>
        </div>
        ...
        <div className={`transform scale-90 transition-all duration-300 ${currentSlide === 7 ? 'opacity-100' : 'opacity-10'} hover:opacity-100 hover:scale-100`}>
          <img src={Image7} alt="Description 3" className="w-[380px] h-[250px] object-cover object-center"/>
          <p className="text-center text-sm font-poppins mt-2">Twin Turbo Charger Assembly</p>
        </div>
        <div className={`transform scale-90 transition-all duration-300 ${currentSlide === 8 ? 'opacity-100' : 'opacity-10'} hover:opacity-100 hover:scale-100`}>
          <img src={Image8} alt="Description 3" className="w-[380px] h-[250px] object-cover object-center"/>
          <p className="text-center text-sm font-poppins mt-2">Twin Turbo Charger Assembly</p>
        </div>
        {/* ... other images ... */}
      </Slider>
