...
import { Owner } from "../Components/Assets";
    ...
    <div>
      ...
      <div className="p-4 font-poppins">
        ...
        <p className="text-xs text-justify">
          Mr. Shaik Waheed is the esteemed founder of SK Turbo Service Works and
        ...
        <p className="text-xs text-justify">
        Founded on a legacy that dates back 40 years, SK Turbo Service Works is a testament to our founder, Mr. Shaik Waheed's unparalleled expertise and dedication. While the company in its current avatar is a few years young, the depth of experience it carries is vast, anchored firmly in Mr. Shaik Waheed's illustrious tenure in both government and private automotive sectors.
        </p>
